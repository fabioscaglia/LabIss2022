...
public class LedSonarOnRasp implements IApplication {

	private EnablerContextForActors ctx;
	
	public static void main(String[] args) {
		CommUtils.aboutThreads("Before start - ");
		new LedSonarOnRasp().doJob("DomainSystemConfig.json", "RadarSystemConfig.json", "CommSystemConfig.json");
...
//			RadarSystemConfig.DLIMIT=12;			
	...
	private void configure() {
		this.ctx = new EnablerContextForActors("ctxRasp", RadarSystemConfig.ctxServerPort, RadarSystemConfig.protcolType);
